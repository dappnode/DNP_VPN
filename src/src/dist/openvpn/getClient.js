...
const fetchInternalIp_1 = require("../dappmanager/fetchInternalIp");
...
function getClient(id) {
    return __awaiter(this, void 0, void 0, function* () {
        const DAPPNODE_INTERNAL_IP = yield fetchInternalIp_1.getInternalIpCached();
        try {
            return yield shell_1.shell(`${fetchCredsCommand} ${id}`, {
                env: Object.assign(Object.assign({}, process.env), { DAPPNODE_INTERNAL_IP })
            });
        }
        catch (err) {
